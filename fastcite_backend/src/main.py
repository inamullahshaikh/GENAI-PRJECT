...
from database.api.chat_feedback import router as chat_feedback_router
...
app.include_router(feedback_router)  # Feedback routes
app.include_router(chat_feedback_router)  # Chat feedback routes
