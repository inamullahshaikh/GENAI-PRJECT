...
class EmailService:
    ...
    def send_admin_signup_request_email(self, admin_email: str, admin_name: str, requester_name: str, requester_email: str, requester_username: str):
        """Send email to admins when a new admin signup request is received."""
        subject = "New Admin Signup Request - Action Required 🔐"
        ...
        <head>
            ...
            <style>
                * {{ margin: 0; padding: 0; box-sizing: border-box; }}
                body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #2d3748; background-color: #f7fafc; padding: 20px; }}
                .email-wrapper {{ max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }}
                .header {{ background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); color: white; padding: 50px 30px; text-align: center; }}
                .header h1 {{ font-size: 28px; font-weight: 700; margin-bottom: 10px; }}
                .content {{ padding: 40px 35px; }}
                .greeting {{ font-size: 18px; color: #1a202c; margin-bottom: 20px; font-weight: 600; }}
                .message {{ font-size: 16px; color: #4a5568; margin-bottom: 25px; line-height: 1.8; }}
                .info-box {{ background: #f7fafc; border: 2px solid #e2e8f0; padding: 25px; border-radius: 8px; margin: 25px 0; }}
                ...
                .cta-box {{ background: linear-gradient(135deg, #f0f4ff 0%, #e0e7ff 100%); border: 2px solid #8b5cf6; padding: 25px; border-radius: 8px; margin: 30px 0; text-align: center; }}
                .cta-box p {{ font-size: 16px; color: #4c1d95; font-weight: 600; margin-bottom: 10px; }}
                .footer {{ background-color: #f7fafc; padding: 25px 35px; text-align: center; border-top: 1px solid #e2e8f0; }}
                .footer p {{ font-size: 12px; color: #a0aec0; margin: 5px 0; }}
            </style>
        </head>
        <body>
            <div class="email-wrapper">
                <div class="header">
                    <h1>🔐 Admin Signup Request</h1>
                    <p>Action Required</p>
                </div>
                <div class="content">
                    <div class="greeting">Hello {admin_name},</div>
                    <div class="message">
                        A new admin signup request has been submitted and requires your review and approval.
                    </div>
                    <div class="info-box">
                        <div class="info-row">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{requester_username}</span>
                        </div>
                    </div>
                    <div class="cta-box">
                    ...
                    <div class="message">
                        You can access the admin panel at: <a href="{FRONTEND_URL}/admin/signup-requests" style="color: #8b5cf6; text-decoration: none; font-weight: 600;">{FRONTEND_URL}/admin/signup-requests</a>
                    </div>
                </div>
                <div class="footer">
                    <p>Best regards,<br><span style="color: #8b5cf6; font-weight: 600;">The FastCite Team</span></p>
                </div>
            </div>
        </body>
        </html>
        ...
        text_body = f"""
        Admin Signup Request - Action Required
        
        Hello {admin_name},
        
        A new admin signup request has been submitted and requires your review.
        ...
        Admin Panel: {FRONTEND_URL}/admin/signup-requests
    ...
    def send_admin_signup_approved_email(self, user_email: str, user_name: str, username: str, admin_name: str):
        """Send email to user when their admin signup request is approved."""
        subject = "Admin Account Approved - Welcome to FastCite! 🎉"
        ...
        <head>
            ...
            <style>
                * {{ margin: 0; padding: 0; box-sizing: border-box; }}
                ...
                .greeting {{ font-size: 18px; color: #1a202c; margin-bottom: 20px; font-weight: 600; }}
                .message {{ font-size: 16px; color: #4a5568; margin-bottom: 25px; line-height: 1.8; }}
                .success-box {{ background: #d1fae5; border: 2px solid #10b981; padding: 25px; border-radius: 8px; margin: 25px 0; text-align: center; }}
                .success-box p {{ font-size: 18px; color: #065f46; font-weight: 600; }}
                .cta-button {{ display: inline-block; background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); color: white; padding: 15px 30px; border-radius: 8px; text-decoration: none; font-weight: 600; margin: 20px 0; }}
                .footer {{ background-color: #f7fafc; padding: 25px 35px; text-align: center; border-top: 1px solid #e2e8f0; }}
                .footer p {{ font-size: 12px; color: #a0aec0; margin: 5px 0; }}
            </style>
        </head>
        <body>
            <div class="email-wrapper">
                ...
                <div class="content">
                    <div class="greeting">Hello {user_name},</div>
                    <div class="message">
                        Great news! Your admin account request has been approved by {admin_name}. Your account has been created and you can now log in to access the admin panel.
                    </div>
                    <div class="success-box">
                        <p>✅ Your admin account is active!</p>
                    </div>
                    <div class="message">
                        You can now log in with your credentials:
                        <br><strong>Username:</strong> {username}
                        <br><strong>Email:</strong> {user_email}
                    </div>
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="{FRONTEND_URL}/login" class="cta-button">Log In to Admin Panel</a>
                    </div>
                </div>
                <div class="footer">
                    <p>Best regards,<br><span style="color: #8b5cf6; font-weight: 600;">The FastCite Team</span></p>
        ...
        text_body = f"""
        Admin Account Approved - Welcome to FastCite!
        
        Hello {user_name},
        
        Great news! Your admin account request has been approved by {admin_name}. Your account has been created and you can now log in.
